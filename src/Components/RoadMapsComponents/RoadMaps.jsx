...
const RoadMaps = () => {
  ...
  return (
    <div className="roadMaps">
      <div className="mainSection bg-[#0d0b21] w-full rounded-bl-[30%] md:rounded-bl-[50%] min-h-96 max-md:pt-24 flex justify-center items-center pt-28 flex-col">
      ...
      <div className="RoadSections p-5 flex flex-wrap justify-center gap-6 items-center">
        {filteredRoad.map((track, index) => (
          <Link
            ...
            className="frontRoad cursor-pointer hover:shadow-md hover:bg-[#17143a] transition-all bg-[#0d0b21] p-5 flex items-center rounded-lg justify-between h-32 w-96 max-md:w-80"
          >
