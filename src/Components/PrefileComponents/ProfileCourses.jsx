...
const ProfileCourses = () => {
  ...
  const handleSelectedCourses = (course) => {
    userData.courses.splice([course], 1);
  ...
  return (
    <div className="">
      {userData ? (
        <div className="text-white font-bold text-3xl w-full text-center flex gap-9 justify-center flex-wrap">
